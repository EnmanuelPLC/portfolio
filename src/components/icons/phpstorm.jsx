...
const Phpstorm = () => (
    <svg viewBox="0 0 128 128">
        <defs>
            <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="25.8" y1="33.6" x2="33.95" y2="17.31"
                            gradientTransform="rotate(.104) scale(1.21905)">
                <stop offset="0" stop-color="#af1df5"></stop>
                <stop offset=".21" stop-color="#bc20e4"></stop>
                <stop offset=".63" stop-color="#dd29b8"></stop>
                <stop offset="1" stop-color="#ff318c"></stop>
            </linearGradient>
            <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="1.56" y1="67.23" x2="35.95" y2="21.8"
                            gradientTransform="rotate(.104) scale(1.21905)">
                <stop offset=".02" stop-color="#6b57ff"></stop>
                <stop offset=".42" stop-color="#b74af7"></stop>
                <stop offset=".75" stop-color="#ff318c"></stop>
            </linearGradient>
            <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="89.3" y1="65.79" x2="65.46" y2="9.23"
                            gradientTransform="rotate(.104) scale(1.21905)">
                <stop offset="0" stop-color="#293896"></stop>
