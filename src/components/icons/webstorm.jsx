...
const Webstorm = () =>  (
    <svg viewBox="0 0 128 128">
        ...
        <path fill="url(#a)"
              d="M21.262 111.25 5.484 17.75 34.656 5.645l18.63 11.07 17.066-9.207 35.558 13.656-19.94 101.352Zm0 0"></path>
        <path fill="url(#b)"
              d="M122.516 45.117 107.41 7.813l-27.402-2.33L37.707 46.13 49.09 98.512l21.262 14.91 52.164-30.953-12.801-24.004Zm0 0"></path>
